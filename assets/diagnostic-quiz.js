...
(function () {
  ...
  var QUESTIONS = [
    ...
    },
    {
      ...
      options: [
        { points: 4, label: 'Ready — we’ve already begun redesigning around it' },
        { points: 3, label: 'Partially ready — some teams are prepared' },
        { points: 2, label: 'Not really — we’d ship the tech and figure out the rest later' },
        { points: 1, label: 'Unprepared, and we don’t have a plan' },
    ...
    },
    {
      ...
      options: [
        ...
        { points: 0, label: 'No, we’re going on vendor or vibes' },
      ],
    },
    {
      id: 'q8', section: 2,
      text: 'Do you have the in-house expertise (or vetted partners) to build, deploy, monitor, and maintain this automation responsibly?',
      options: [
        { points: 4, label: 'Yes, across all four phases' },
        { points: 3, label: 'For build and deploy, less so for monitor and maintain' },
        { points: 2, label: 'Partial expertise — gaps we’re aware of' },
        { points: 1, label: 'Significant gaps' },
        { points: 0, label: 'We don’t have the expertise and haven’t sourced it' },
      ],
    },
    {
      id: 'q9', section: 2,
      text: 'How clearly has your team decomposed the target workflow into routine vs. judgment-driven steps?',
      options: [
        { points: 4, label: 'Completely — we’ve done a formal task analysis' },
        { points: 3, label: 'Mostly — we have a shared mental model' },
        { points: 2, label: 'Informally — we’ve discussed it' },
        { points: 1, label: 'We’ve thought about the workflow at the job level, not the task level' },
    ...
    },
    {
      ...
      options: [
        { points: 4, label: 'Yes — formal ecosystem map exists' },
        { points: 3, label: 'Yes — informally documented' },
        { points: 2, label: 'Partially — for the obvious ones' },
        { points: 1, label: 'We have a rough mental model' },
        { points: 0, label: 'No' },
      ],
    },
    {
      id: 'q11', section: 3,
      text: 'Can you articulate the user’s underlying Job-To-Be-Done that this automation would serve — without naming a specific tool or feature?',
      options: [
        { points: 4, label: 'Yes, clearly, grounded in user research' },
        { points: 3, label: 'Yes, based on internal expertise and informal user input' },
        { points: 2, label: 'Partially — we’re still refining it' },
        { points: 1, label: 'Not really — this is a feature looking for a problem' },
        { points: 0, label: 'We’re starting from the technology, not the user' },
      ],
    },
    {
      id: 'q12', section: 3,
    ...
    },
    {
      ...
      options: [
        ...
        { points: 2, label: 'Considered informally' },
        { points: 1, label: 'Haven’t formally examined it' },
        { points: 0, label: 'Don’t know' },
      ],
    },
    {
      ...
      options: [
        { points: 4, label: 'Yes, explicitly — we’ve stress-tested for them (e.g., pre-mortem, Futures Wheel)' },
        { points: 3, label: 'Yes, we’ve discussed them' },
        { points: 2, label: 'Vaguely' },
        { points: 1, label: 'No, we haven’t considered them' },
        { points: 0, label: 'Not applicable / haven’t thought about it' },
      ],
    },
    {
      id: 'q15', section: 3,
      ...
      options: [
        { points: 4, label: 'Yes, from the start — co-designing' },
        { points: 3, label: 'Yes, but starting later in the process' },
        { points: 2, label: 'They’ll be consulted before launch' },
        { points: 1, label: 'They’ll be informed at launch' },
        { points: 0, label: 'No — and we’ve seen pushback as a result' },
      ],
    },
  ];

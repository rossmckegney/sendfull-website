import{u as C,a as M,b as E,m as P,j as w,T as I}from"./index-NdbvJEo4.js";import{r as t,a as D,b}from"./framer-motion-D-pNuhrv.js";import{D as A,G as T,T as G,C as F,V as k,W as V,L as j,P as q,S as U,M as H,U as O,a as W,b as N,c as B,A as X}from"./three-DcKjkeDs.js";function Y(r,e){let s=0;return function(...g){const v=new Date;v-s>=e&&(r(...g),s=v)}}F.enabled=!0;const R=new A,J=new T;R.setDecoderPath("/draco/");J.setDRACOLoader(R);new G;const K=r=>{r==null||r.traverse(e=>{if(e.isMesh)if(e.geometry.dispose(),e.material.isMaterial)S(e.material);else for(const s of e.material)S(s)})},S=r=>{var e,s,g;r.dispose();for(const v of Object.keys(r)){const i=r[v];i&&typeof i=="object"&&"minFilter"in i&&(i.dispose(),(g=(s=(e=i.source)==null?void 0:e.data)==null?void 0:s.close)==null||g.call(s))}},Q=r=>{r.dispose(),r=null},Z=r=>{for(const e of r)e.parent.remove(e)},$=`#define PHONG
